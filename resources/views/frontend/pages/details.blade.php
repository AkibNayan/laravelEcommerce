                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="owl-carousel owl-theme" data-plugin-options="{'items': 1, 'margin': 10}">
                            ...
                            @if ($i <= 3 ) <div>
                                <img height="300" class="img-fluid" src="{{ asset('backend/img/products/'. $img->image) }}" alt="{{ $productDetails->title }}">
                        </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="summary entry-summary">
                        ...
                        <p>
                            ...
                            @elseif ($productDetails->quantity <=0) <span style="color:#ff0000;"><strong>Out Of Stock</strong></span>
                                @endif
                        </p>

                        <form action="{{ route('cart.store') }}" method="POST" class="cart" enctype="multipart/form-data">
                            @csrf
